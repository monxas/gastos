...
const DEFAULT_CATEGORIES = [
  ...
  { name: 'Supermercado', icon: '🛒', color: '#34C759' },
  { name: 'Restaurantes', icon: '🍽️', color: '#FF9500' },
  { name: 'Transporte', icon: '🚗', color: '#4ECDC4' },
  { name: 'Gasolina', icon: '⛽', color: '#FF3B30' },
  { name: 'Compras', icon: '🛍️', color: '#45B7D1' },
  { name: 'Entretenimiento', icon: '🎬', color: '#AF52DE' },
  { name: 'Salud', icon: '💊', color: '#FF2D55' },
  { name: 'Hogar', icon: '🏠', color: '#DDA0DD' },
  { name: 'Servicios', icon: '💡', color: '#FFCC00' },
  { name: 'Suscripciones', icon: '📺', color: '#5856D6' },
  { name: 'Telefono', icon: '📱', color: '#007AFF' },
  { name: 'Internet', icon: '📡', color: '#00C7BE' },
  { name: 'Educacion', icon: '📚', color: '#5856D6' },
  { name: 'Ropa', icon: '👕', color: '#FF6B6B' },
  { name: 'Belleza', icon: '💄', color: '#FF2D55' },
  { name: 'Deporte', icon: '🏃', color: '#30D158' },
  { name: 'Mascotas', icon: '🐕', color: '#FFCC00' },
  { name: 'Regalos', icon: '🎁', color: '#AF52DE' },
  { name: 'Viajes', icon: '✈️', color: '#007AFF' },
  { name: 'Seguros', icon: '🛡️', color: '#8E8E93' },
  { name: 'Impuestos', icon: '🏛️', color: '#8E8E93' },
  { name: 'Alquiler', icon: '🔑', color: '#FF9500' },
